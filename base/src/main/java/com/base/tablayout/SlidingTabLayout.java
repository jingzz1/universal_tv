...
import com.base.R;
import com.base.tablayout.listener.OnTabSelectListener;
import com.base.tablayout.utils.UnreadMsgUtils;
import com.base.tablayout.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mUnSelectTextSize = ta.getDimension(R.styleable.SlidingTabLayout_tl_unSelectTextSize,mTextsize);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab ? mSelectTextSize:mUnSelectTextSize);
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, isSelect ? mSelectTextSize:mUnSelectTextSize);
